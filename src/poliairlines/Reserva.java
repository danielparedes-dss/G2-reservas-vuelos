...
public class Reserva {
    ...
    public void cancelarReserva() {
        ...
        if (this.asientoAsignado != null) {
            this.asientoAsignado.liberarAsiento();
        }
    }

    public String getCodigoReserva() { return codigoReserva; }
    public Pasajero getPasajeroAsociado() { return pasajeroAsociado; }
    public Vuelo getVueloAsociado() { return vueloAsociado; }
    public Asiento getAsientoAsignado() { return asientoAsignado; }
